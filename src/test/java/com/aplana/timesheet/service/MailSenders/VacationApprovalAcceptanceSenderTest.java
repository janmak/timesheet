 ...
 * Date: 08.08.13
 */
public class VacationApprovalAcceptanceSenderTest extends AbstractTest {
    private static final Logger logger = LoggerFactory.getLogger(VacationApprovalAcceptanceSenderTest.class);
    ...
    public VacationApprovalAcceptanceSender vacationApprovalAcceptanceSender;
    ...
    public List<Mail> getMainMailList(VacationApproval vacationApproval) {
        return vacationApprovalAcceptanceSender.getMainMailList(vacationApproval);
    }
    ...
    public void gettingData () {
        ...
        emailList.add(vacationApproval.getVacation().getEmployee().getEmail());

        vacationApprovalAcceptanceSender = new VacationApprovalAcceptanceSender(sendMailService, propertyProvider);
    }
    ...
    @Test
    public void testVacationApprovalAcceptanceSenderTest () {
