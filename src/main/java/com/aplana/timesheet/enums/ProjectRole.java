...
public enum ProjectRole {
    ADMINISTRATOR(12, "GM", "Генеральный директор,Заместитель генерального директора", "Администрация", LEADER),
    ...
    MANAGER(11, "MR", "Старший менеджер по качеству,Менеджер по качеству", "Менеджер", LEADER),
    PROJECT_MANAGER(1, "MN", "Ведущий руководитель проекта,Руководитель проекта,Старший руководитель проекта," +
            "Администратор проекта", "Руководитель проекта", LEADER),
    LEADING_ANALYST(13, "AL", "Ведущий инженер-аналитик", "Ведущий аналитик", LEADER),
    HEAD_OF_DEVELOPMENT(3, "TL", "Руководитель группы разработки,Старший разработчик БД",
            "Руководитель группы разработки", LEADER),
    ...
    HEAD_OF_CENTER(9, "DR", "Руководитель центра компетенции,Руководитель СК,Руководитель направления тестирования," +
            "Руководитель центра тестирования,Заместитель руководителя центра тестирования", "Руководитель центра", LEADER),
    ...
    HEAD(19, "DR", "Руководитель центра компетенции,Руководитель СК,Руководитель направления тестирования," +
            ...
            "Ведущий руководитель проекта,Руководитель проекта,Старший руководитель проекта", "Руководитель", LEADER)
    ;
